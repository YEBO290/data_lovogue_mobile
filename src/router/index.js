...
import specialEditionList from './../components/specialEdition' // 特辑列表 
...
import bag from './../components/login/bag' // 
...
const router = new Router({
    routes:[
        ...
        {   // 特辑列表
            path: '/specialEditionList',
            name: 'specialEditionList',
            component: specialEditionList,
            meta:{
                flag: 'list',
                showToTop: true
            }
